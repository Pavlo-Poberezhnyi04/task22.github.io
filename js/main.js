...
console.log(counterr(100)); // 100
console.log(counterr()); // 0
console.log(counterr()); // 101
console.log(counterr()); // 102
console.log(counterr(500)); // 500
console.log(counterr()); // 501
console.log(counterr()); // 502
console.log(counterr(0)); // 0
console.log(counterr()); // 0
console.log(counterr()); // 1
...
const myPow = (a, b, myPrint) => {
  ...
  if (b < 0) {
      let res = 1 / myPow(a, -b, (a, b, res) => res);
      return myPrint(a, b, res);
  }
  let res = a * myPow(a, b - 1, (a, b, res) => res);
  return myPrint(a, b, res);
};
...
const multiplyTwo = myMul.bind(null, 2)
const myDouble = (n) => {
  return multiplyTwo(n);
}
...
const multiplyThree = myMul.bind(null, 3)
const myTriple = (n) => {
  return multiplyThree(n);
}
